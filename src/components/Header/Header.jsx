        ...
        <div className='header_box'>
          <div className='header_little-box'>
            ...
            <div className='header_btn'>
              ...
              <a href='http://patriciafernandezruibal.com/' target="_blank" rel="noopener noreferrer"><button className='header_btn2'>Portfolio <svg width="28px" height="28px" viewBox="0 0 24 24" strokeWidth="1.5" fill="none" xmlns="http://www.w3.org/2000/svg" color="#000000"><path d="M21 3h-6m6 0l-9 9m9-9v6" stroke="#000000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path><path d="M21 13v6a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h6" stroke="#000000" strokeWidth="1.5" strokeLinecap="round"></path></svg></button></a>
            </div>
